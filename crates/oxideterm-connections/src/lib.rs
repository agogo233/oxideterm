...
pub use store::{
    ...
    PROFILE_CREDENTIAL_KIND, PreparedProfileCredentials, PreparedSavedConnectionsSync,
    PrivilegeCredentialKind, ProfileCredentialRestoreSummary, ProxyHopInfo, RemoteDesktopProfile,
